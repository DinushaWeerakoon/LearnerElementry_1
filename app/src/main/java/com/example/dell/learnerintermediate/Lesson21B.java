...
public class Lesson21B extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView txt5= (TextView) view.findViewById(R.id.txt_5);
        TextView txt6= (TextView) view.findViewById(R.id.txt_6);
        TextView txt7= (TextView) view.findViewById(R.id.txt_7);
