 ...
 */
public class Lesson15C extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Uri videoUri = Uri.parse("android.resource://com.example.dell.learnerintermediate/raw/less_15_c");
